...
<main class="fix">
    <section class="banner-area-nine banner-bg-nine" data-background="<?= asset_url('img/banner/h_hero_bg.png') ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="banner-content-nine">
                        <h2 class="title wow design-title" data-aos="fade-up" data-aos-delay="200"><?= esc(site_trans('hero_title', $locale)) ?></h2>
                        <p data-aos="fade-up" data-aos-delay="400"><?= esc(site_trans('hero_desc', $locale)) ?></p>
                        <div class="banner-btn-nine" data-aos="fade-up" data-aos-delay="600">
                            <a href="<?= page_url('about', $locale) ?>" class="btn btn-three btn-four btn-has-i"><?= btn_icon('read_more') ?><?= esc(site_trans('btn_read_more', $locale)) ?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="banner-shape-wrap-nine">
            <img src="<?= asset_url('img/banner/h10_hero_shape01.png') ?>" alt="shape" data-aos="fade-down-right" data-aos-delay="600">
            <img src="<?= asset_url('img/banner/h10_hero_shape02.png') ?>" alt="shape" data-aos="fade-up-left" data-aos-delay="600">
            <img src="<?= asset_url('img/banner/h10_hero_shape03.png') ?>" alt="shape" data-aos="fade-up-left" data-aos-delay="800">
        </div>
    </section>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="features-item-two">
                            <div class="features-icon-two"><i class="<?= esc($f['icon'] ?? '', 'attr') ?>"></i></div>
                            <div class="features-content-two">
                                <h4 class="title"><?= esc(site_trans((string) ($f['title_key'] ?? ''), $locale)) ?></h4>
                                <p><?= esc((string) ($f['desc'] ?? '')) ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
    ...
    <section class="about-area-three">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-9">
                    <div class="about-img-wrap-three">
                        <img src="<?= asset_url('img/images/h_about_img01.png') ?>" alt="" data-aos="fade-down-right" data-aos-delay="0">
                        <img src="<?= asset_url('img/images/h_about_img02.png') ?>" alt="" data-aos="fade-left" data-aos-delay="400">
                        <div class="experience-wrap" data-aos="fade-up" data-aos-delay="300">
                            <h2 class="title"><?= esc($leadership['experience_years'] ?? '15+') ?> <span><?= esc(site_trans('homepage_exp_years', $locale)) ?></span></h2>
                            <p><?= esc(site_trans('homepage_exp_label', $locale)) ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-content-three">
                        <div class="section-title-two mb-20 tg-heading-subheading animation-style3">
                            <span class="sub-title span1"><?= esc(site_trans('about_subtitle', $locale)) ?></span>
                            <h2 class="title tg-element-title"><?= esc(site_trans('about_title', $locale)) ?></h2>
                        </div>
                        <p class="info-one"><?= esc(site_trans('homepage_about_lead', $locale)) ?></p>
                        <div class="about-list-two">
                            <ul class="list-wrap">
                                <li><i class="fas fa-arrow-right"></i><?= esc(site_trans('homepage_about_list_1', $locale)) ?></li>
                                <li><i class="fas fa-arrow-right"></i><?= esc(site_trans('homepage_about_list_2', $locale)) ?></li>
                                <li><i class="fas fa-arrow-right"></i><?= esc(site_trans('homepage_about_list_3', $locale)) ?></li>
                                <li><i class="fas fa-arrow-right"></i><?= esc(site_trans('homepage_about_list_4', $locale)) ?></li>
                            </ul>
                        </div>
                        <p><?= esc(site_trans('homepage_about_conclusion', $locale)) ?></p>
                        <div class="about-author-info">
                            <div class="thumb">
                                <img src="<?= asset_url('img/images/' . ($leadership['ceo_image'] ?? 'about_ceo.png')) ?>" alt="CEO">
                            </div>
                            <div class="content">
                                <h2 class="title"><?= esc($leadership['ceo_name'] ?? '') ?></h2>
                                <span><?= esc(site_trans('about_ceo', $locale)) ?></span>
                            </div>
                            <div class="signature">
                                <img src="<?= asset_url('img/images/' . ($leadership['signature_image'] ?? 'signature.png')) ?>" alt="Signature">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="about-shape-wrap-two">
            <img src="<?= asset_url('img/images/h2_about_shape01.png') ?>" alt="">
            <img src="<?= asset_url('img/images/h2_about_shape02.png') ?>" alt="">
            <img src="<?= asset_url('img/images/h2_about_shape03.png') ?>" alt="" data-aos="fade-left" data-aos-delay="500">
        </div>
    </section>
                ...
                <div class="col-lg-4">
                    <div class="services-inner-content">
                        <div class="section-title-two white-title mb-15 tg-heading-subheading animation-style2">
                            <span class="sub-title tg-element-title span1"><?= esc(site_trans('services_subtitle', $locale)) ?></span>
                            <h2 class="title tg-element-title"><?= esc(site_trans('services_title', $locale)) ?></h2>
                        </div>
                        <p><?= esc(site_trans('homepage_services_lead', $locale)) ?></p>
                        <a href="<?= page_url('services', $locale) ?>" class="btn btn-three border-btn btn-has-i"><?= btn_icon('services') ?><?= esc(site_trans('services_btn', $locale)) ?></a>
                    </div>
                </div>
                <div class="col-lg-8">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-item-five">
                        <div class="counter-icon-five"><i class="<?= esc($c['icon'] ?? '', 'attr') ?>"></i></div>
                        <div class="counter-content-five">
                            <p><?= esc(site_trans((string) ($c['label_key'] ?? ''), $locale)) ?></p>
                            <span class="count odometer" data-count="<?= esc((string) ($c['count'] ?? 0), 'attr') ?>"></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-4">
                    <div class="view-all-btn text-end mb-30">
                        <a href="<?= page_url('projects', $locale) ?>" class="btn btn-three btn-has-i"><?= btn_icon('projects') ?><?= esc(site_trans('projects_btn', $locale)) ?></a>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
    ...
    <?= $this->include('front/partials/testimonial-section') ?>
