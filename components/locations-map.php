...
<section class="locations-map locations-map-pro" aria-label="<?php echo htmlspecialchars(__('locations_title')); ?>">
    <div class="locations-map-glow" aria-hidden="true"></div>

    <?php if ($locations_show_header): ?>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="locations-map-head text-center tg-heading-subheading animation-style2">
                        <span class="locations-map-eyebrow"><?php echo __('locations_eyebrow'); ?></span>
                        <h2 class="title tg-element-title"><?php echo __('locations_title'); ?></h2>
                        <p class="locations-map-lead"><?php echo __('locations_subtitle'); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid locations-map-stage-outer">
